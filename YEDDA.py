...
from tkinter.filedialog import askopenfilename, asksaveasfilename # python3替换
from tkinter.filedialog import Open
# import tkFileDialog
import tkinter.font as tkFont # python3替换
# import tkFont
import re
...
from tkinter import messagebox # python3替换
# import tkMessageBox
import json
...
class Example(Frame):
    ...
    def renewPressCommand(self):
        ...
        self.setMapShow()
        messagebox.showinfo("Remap Notification", "Shortcut map has been updated!\n\nConfigure file has been saved in File:" + self.configFile)
    ...
    def savenewPressCommand(self):
        ...
        self.configFile = asksaveasfilename(initialdir="./configs/",
        ...
        with open(self.configFile, 'wb') as fp:
            json.dump(self.pressCommand, fp)
        self.setMapShow()
        messagebox.showinfo("Save New Map Notification", "Shortcut map has been saved and updated!\n\nConfigure file has been saved in File:" + self.configFile)
